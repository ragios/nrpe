...
pub unsafe extern "C" fn read_config_file(mut fname: *mut libc::c_char) -> libc::c_int {
    ...
    *fresh1 = b"check_nrpe\0" as *const u8 as *const libc::c_char as *mut libc::c_char;
    bufp = buf;
    while argc < 50 as libc::c_int {
        ...
        *fresh2 = my_strsep(&mut bufp, delims);
        let fresh3 = argc;
        argc = argc + 1;
        if (*argv.offset(fresh3 as isize)).is_null() {
            break;
        }
        if bufp.is_null() {
            break;
    ...
    if use_ssl == 1 as libc::c_int {
        ...
        match sslprm.ssl_proto_ver as libc::c_uint {
            11 => {
                ...
                current_block_43 = 5479457834166308058;
            }
            12 => {
                current_block_43 = 5479457834166308058;
            }
            9 => {
                ...
                current_block_43 = 5928446878583337403;
            }
            10 => {
                current_block_43 = 5928446878583337403;
            }
            7 => {
                ...
                current_block_43 = 11383564211678487406;
            }
            8 => {
                current_block_43 = 11383564211678487406;
            }
            5 => {
                ...
                current_block_43 = 2143806232193708257;
            }
            6 => {
                current_block_43 = 2143806232193708257;
            }
            3 => {
                ...
                current_block_43 = 17310091788743295281;
            }
            4 => {
                current_block_43 = 17310091788743295281;
            }
...
pub unsafe extern "C" fn graceful_close(
    ...
    loop {
        ...
        let fresh4 = &mut __d0;
        let fresh5;
        let fresh6 = (::core::mem::size_of::<fd_set>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<__fd_mask>() as libc::c_ulong);
        let fresh7 = &mut __d1;
        let fresh8;
        let fresh9 = &mut *(in_0.__fds_bits)
            .as_mut_ptr()
